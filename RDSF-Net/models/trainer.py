...
class CDTrainer():
    ...
    def _forward_pass(self, batch):
        ...
        self.G_pred, self.G_middle1, self.G_middle2 = self.net_G(img_in1, img_in2)


    def _backward_G(self):
        gt = self.batch['L'].to(self.device).long()
        self.G_loss = self._pxl_loss(self.G_pred, gt) + 0.5 * self._pxl_loss(self.G_middle1, gt) + 0.2 * self._pxl_loss(self.G_middle2, gt)
        # + 0.5 * (self._pxl_loss(self.G_middle1, gt) + self._pxl_loss(self.G_middle2, gt))
